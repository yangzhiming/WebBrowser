...
static const UINT XBM_MSG_NAVIGATE      =   XBM_MSG_BEGIN_ID + 3;
static const UINT XBM_MSG_PROCESSCREATED =  XBM_MSG_BEGIN_ID + 4;
static const UINT XBM_MSG_HOSTWNDSIZE    = XBM_MSG_BEGIN_ID + 5;
